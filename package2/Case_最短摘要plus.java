...
public class Case_最短摘要plus {
    public static void main(String[] args) {
//        solve2(new String[]{"1","0","1","3","3"} , new String[]{"0","1","3"});
//        solve1(new String[]{"a", "b", "c", "seed", "h", "e", "f", "c", "c", "seed", "e", "f", "seed", "c"}, new String[]{"c", "e"});
        ...
        solve2(new String[]{"1","2","0","3","1","3"} , new String[]{"0","1","3"});
        solve2(new String[]{"a","b","c","d","e","f","d","c"} , new String[]{"e" , "c"}) ;
        solve2(new String[]{"a", "b", "c", "seed", "c", "e", "f", "c", "c", "seed", "e", "f", "seed", "c"}, new String[]{ "c", "e", "f"});
        solve2(new String[]{"a", "b", "a", "a", "b", "c", "d", "h", "e", "f", "f"}, new String[]{"b", "c", "d"});
    }
